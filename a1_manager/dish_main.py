...
def calibrate_dish(dish_name: str, run_dir: Path, nikon: NikonTi2, overwrite: bool = False) -> dict[str, WellCircleCoord | WellSquareCoord]:
    ...
    dish_calibration = dish.calibrate_dish(nikon, overwrite)
