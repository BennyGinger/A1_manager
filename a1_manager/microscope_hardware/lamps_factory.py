...
def get_lamp(core: Core, lamp_name: str) -> Lamp:
    ...
    """
    if lamp_name == 'pE-800':
        from a1_manager.microscope_hardware.lamps.pe800 import pE800
        return pE800(core, lamp_name)
    elif lamp_name == 'pE-4000':
        from a1_manager.microscope_hardware.lamps.pe4000 import pE4000
        return pE4000(core, lamp_name)
    elif lamp_name == 'DiaLamp':
        from a1_manager.microscope_hardware.lamps.dia_lamp import DiaLamp
